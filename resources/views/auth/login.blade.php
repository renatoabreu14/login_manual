                        ...
                        <form method="post" action="{{route('login.attempt')}}">
                            ...
                            <div class="card card-login card-hidden">
                                ...
                                <div class="footer text-center">
                                    <button type="submit" class="btn btn-rose btn-simple btn-wd btn-lg">Let's go</button><br>
                                    <a href="{{route('redirect')}}" class="btn btn-facebook"><i class="fa fa-facebook"></i> Facebook</a>
                                </div>
                            </div>
                        </form>
                    </div>
